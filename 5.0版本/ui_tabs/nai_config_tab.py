...
class NAIConfigTab(ctk.CTkFrame):
    ...
    def build_ui(self):
        ...
        self.model_display_var = StringVar(value=model_options[0]) # 默认选中第一个
        ...
        self.uc_preset_display_var = StringVar(value=uc_preset_options[0]) # 默认选中第一个 ("Heavy")
